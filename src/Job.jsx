            ...
            <div className="w-full">
                <div className="flex flex-col gap-4">
                    <div className="flex flex-col gap-2">
                        ...
                        <h4 className="text-palette-text text-lg leading-none">{job.position}</h4>
                        <h4 className="text-palette-text text-lg leading-none">{job.location}</h4>
...

                    {
                        job.link &&
                        <div className="flex flex-wrap gap-2">
                            <a href={job.link} target="_target" className="text-palette-text px-2 py-2 bg-palette-secondary/50 hover:bg-palette-primary border border-palette-secondary shadow-md shadow-palette-border-glow/60 rounded-[6px] transition duration-200 ease-in-out select-none leading-none">
                                Website
                            </a>
                        </div>
                    }
