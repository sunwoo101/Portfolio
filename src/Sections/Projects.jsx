...
const projects = [
  ...
  },
  {
    ...
    description:
      "An open-source TradingView indicator with over 150,000 views that identifies Smart Money Concept (SMC) levels and sends real-time webhook alerts when key price levels are reached.",
    stack: ["Pine Script"],
